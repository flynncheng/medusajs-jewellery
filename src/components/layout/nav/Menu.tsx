          ...
          <SheetContent side="left">
            <Accordion type="single" collapsible className="mt-4 w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>Shoes</AccordionContent>
                <AccordionContent>Clothing</AccordionContent>
              </AccordionItem>
            ...
            <div className="flex flex-1 items-center justify-between border-b py-4 font-medium transition-all hover:underline">
              Jordan
            </div>
          </SheetContent>
        </Sheet>
        ...
        <NavigationMenu>
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                  {components.slice(2).map((component) => (
                    <ListItem
                      key={component.title}
                      title={component.title}
                      href={component.href}
